...
/*今回追加した、console.log('同じ名前なら、同じ結果を出力することのテスト'); と console.log('同じ名前なら、同じ結果を出力することのテスト終了'); の間にテストを追加してください。

テストは「太郎」「次郎」「花子」の 3 つを書いてください。

完成したら、Chrome で確認しましょう。
正しくテストできていれば、下のメッセージが表示されるはずです。*/